// Este codigo esta mal (se deben corregir por Marquinhos)
...
//   private NodoObservacion listaObservaciones;
...
//       return;
//     }
//     if (listaObservaciones.getObservacion().getId() == idObservacion) {
